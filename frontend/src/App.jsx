...
const st = {
  ...
  authWrapper: { position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, display: 'flex', flexDirection: 'column', alignItems: 'flex-start', justifyContent: 'center', background: '#0f172a', padding: '40px 20px', paddingLeft: '60px', boxSizing: 'border-box', overflow: 'auto' },
